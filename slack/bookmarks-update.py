...
from lib import convert_name, get_managed_channels, get_managed_channels_with_resources, get_managed_channels_with_resources_sessions, VIDEOS, SESSIONS
import time
...
for res in managed_channels():
    ...
    # Planned bookmarks
    new_bookmarks = [('Code of Conduct', 'https://galaxyproject.org/community/coc/')] + list(bookmarkify(videos))
